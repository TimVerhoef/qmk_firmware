...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------|
   * | LSHIFT | Z   | X    | C   | V   | B   | N   | M   | ,<  | .>  | RS    |
   * '-----------------------------------------------------------------------'
   *         | LALT | LGUI | SPACE     | TAB           | RGUI | LW   |
   *         '-------------------------------------------------------'
   */
  [_BL] = LAYOUT(
    ...
    KC_LSFT,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,    KC_N,  KC_M,  KC_COMM, KC_DOT, RAISE,
    KC_NO,     KC_LALT, KC_LGUI, KC_SPC, KC_TAB, KC_RGUI, LOWER, KC_NO
  ),
